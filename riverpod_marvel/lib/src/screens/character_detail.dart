...
///
/// It is an error to use [CharacterView] without overriding this provider to
/// a non-null value.
///
/// See also:
///
...
///
/// - [CharacterView], which consumes this provider and [character] to show the
///   informations of one specific [Character].
...
///
/// This rarely performs an HTTP request as most of the time the [Character]
/// is already pre-fetched by the home page.
///
/// The catch is: when using deep-links, a user may want to see a [Character]
/// without clicking on its item in the home page - in which case the
/// [Character] wasn't obtained yet.
